...
$('#type_filter,#client_filter,#created_by_filter,#filter_starts_at,#filter_ends_at,#user_creators_filter,#client_creators_filter').on('change', function (e, refreshTable) {
    e.preventDefault();
