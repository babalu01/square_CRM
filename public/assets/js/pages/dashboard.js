...
$('#birthday_user_filter').on('change', function (e, refreshTable) {
    e.preventDefault();
...
$('#wa_user_filter').on('change', function (e, refreshTable) {
    e.preventDefault();
    if (typeof refreshTable === 'undefined' || refreshTable) {
        $('#wa_table').bootstrapTable('refresh');
    }
...
$(document).on('click', '.clear-upcoming-wa-filters', function (e) {
    ...
    $('#wa_user_filter').val('').trigger('change', [0]);
    $('#wa_table').bootstrapTable('refresh');
})
...
$('#mol_user_filter').on('change', function (e, refreshTable) {
    e.preventDefault();
    if (typeof refreshTable === 'undefined' || refreshTable) {
        $('#mol_table').bootstrapTable('refresh');
    }
