...
<div class="container mt-3">
    <div class="card">
        <div class="card-body">
            <h1 class="card-title mb-4">Edit Policy</h1>
            @if ($errors->any())
            ...
            <form action="{{ route('policies.update', $policy->id) }}" method="POST">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="" name="start_date" value="{{ $policy->start_date }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="end_date" class="form-label">End Date</label>
                            <input type="date" class="form-control" id="" name="end_date" value="{{ $policy->end_date }}" required>
                        </div>
                        <div class="mb-3">
                ...
                <div class="mt-3">
                    ...
                    <a href="{{ route('policies.show', $policy->id) }}" class="btn btn-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
