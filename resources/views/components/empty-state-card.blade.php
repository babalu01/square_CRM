...
<div class="<?= $flag == 1 ? 'card ' : '' ?>text-center empty-state">
    ...
    <div class="card-body">
        ...
        <div class="misc-wrapper">
            ...
            $hasModal = in_array($typeSlug, ['contracts', 'todos', 'tags', 'status', 'leave-requests', 'contract-types', 'payment-methods', 'allowances', 'deductions', 'notes', 'timesheet', 'taxes', 'units', 'items', 'expense-types', 'expenses', 'payments', 'languages', 'tasks', 'priorities', 'projects', 'workspaces', 'meetings']);
