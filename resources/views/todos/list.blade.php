            ...
            <div class="table-responsive text-nowrap">
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            <td><input type="checkbox" class="selected-items form-check-input" value="{{ $todo->id }}"></td>
                            <td>{{ $todo->id }}</td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <a href="javascript:void(0);" type="button" data-id="{{$todo->id}}" data-type="todos" data-reload="true" title="<?= get_label('delete', 'Delete') ?>" class="card-link mx-4 delete"><i class='bx bx-trash text-danger mx-1'></i></a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
