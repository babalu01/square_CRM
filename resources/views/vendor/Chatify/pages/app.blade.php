...
<div class="messenger">
    <input type="hidden" id="chat_type" value="{{$type??null}}">
    <input type="hidden" id="chat_type_id" value="{{$paramId??null}}">
    ...
    <div class="messenger-listView {{ !!$id ? 'conversation-active' : '' }}">
        ...
        <div class="m-header">
            <nav>
                <a href="#"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">{{$messageLabel}}</span> </a>
                {{-- header buttons --}}
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
            ...
            <div class="settings-alert">
                Important settings for the chat feature are not set. <a href="{{ url('settings/pusher') }}" target="_blank">Click here to configure them now.</a>
            </div>
            @endif
            @endrole
        </div>
