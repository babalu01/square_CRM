            ...
            <form action="{{url('estimates-invoices/update')}}" class="form-submit-event" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <select class="form-control clients_select" id="client_id" name="client_id" data-placeholder="<?= get_label('type_to_search', 'Type to search') ?>" data-allow-clear="false">
                        <option value="{{ $estimate_invoice->client_id }}" selected>{{ $estimate_invoice->client->first_name }} {{ $estimate_invoice->client->last_name }}</option>
                        </select>
                    </div>
                    <div class="mb-3 col-md-6">
                        <label class="form-label" for=""><?= get_label('status', 'Status') ?></label>
                        <select class="form-control js-example-basic-multiple" name="status" data-placeholder="<?= get_label('type_to_search', 'Type to search') ?>" id="status" data-allow-clear="true">
                            <option value=""><?= get_label('please_select', 'Please select') ?></option>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <select id="item_id" name="item_id" class="form-control items_select" data-placeholder="<?= get_label('type_to_search', 'Type to search') ?>" data-allow-clear="true">                            
                        </select>
                        <div class="mt-2">
                            ...
                            <a href="{{ url('items') }}" target="_blank"><button type="button" class="btn btn-sm btn-primary action_manage_items" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="<?= get_label('manage_items', 'Manage items') ?>"><i class="bx bx-list-ul"></i></button></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12" id="estimate-invoice-items">
                            ...
                            <div class="estimate-invoice-item">
                                <div class="d-flex">
                                    ...
                                    <div class="mb-3 col-md-2 mx-1">
                                        <input type="text" id="item_{{$displayIndex}}_title" name="title[]" value="{{$item['title']}}" class="form-control" readonly>
                                    </div>
                                    <div class="mb-3 col-md-2 mx-1">
                                        <textarea class="form-control" id="item_{{$displayIndex}}_description" name="description[]" readonly>{{$item['description']}}</textarea>
                                    </div>
                                    <div class="mb-3 col-md-1 mx-1">
                                    ...
                                    <div class="mb-3 col-md-2 mx-1">
                                        <input type="text" name="rate[]" id="item_{{$displayIndex}}_rate" placeholder="{{format_currency(0,0)}}" class="form-control decimal-currency" min="0" value="{{format_currency($item->pivot->rate,0,false)}}" onchange="update_amount(<?= $displayIndex ?>)">
                                    </div>
                                    <div class="mb-3 col-md-1 mx-1">
                                    ...
                                    <div class="mb-3 col-md-2 mx-1">
                                        <input type="text" name="amount[]" id="item_{{$displayIndex}}_amount" placeholder="{{format_currency(0,0)}}" class="form-control decimal-currency" min="0" value="{{format_currency($item->pivot->amount,0,false)}}" onchange="updateTotals()">
                                    </div>
                                    <div class="mx-1">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="col-md-4 mt-4 text-end">
                            ...
                            <input type="text" class="form-control decimal-currency" name="total" id="sub_total" placeholder="{{format_currency(0,0)}}" value="{{ format_currency($estimate_invoice->total,0,false)}}" onchange="updateFinalTotal()">
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="col-md-8"></div>
                        <div class="col-md-4 mt-4 text-end">
                            ...
                            <input type="text" class="form-control decimal-currency" name="tax_amount" id="total_tax" placeholder="{{format_currency(0,0)}}" value="{{ format_currency($estimate_invoice->tax_amount,0,false)}}" onchange="updateFinalTotal()">
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="col-md-8"></div>
                        <div class="col-md-4 mt-4 text-end">
                            ...
                            <input type="text" class="form-control decimal-currency" name="final_total" id="final_total" placeholder="{{format_currency(0,0)}}" value="{{ format_currency($estimate_invoice->final_total,0,false)}}">
                        </div>
                    </div>
