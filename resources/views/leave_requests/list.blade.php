        ...
        <form action="{{url('leave-requests/update-editors')}}" class="form-submit-event" method="POST">
            ...
            <div class="d-flex justify-content-center">
                <div class="col-8 mb-3 mx-auto">
                    ...
                    <select id="" class="form-control users_select" name="user_ids[]" multiple="multiple" data-placeholder="<?= get_label('type_to_search', 'Type to search') ?>" data-ignore-admins="true">
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <select class="form-select users_select" id="lr_user_filter" aria-label="Default select example" data-placeholder="<?= get_label('select_users', 'Select Users') ?>" multiple>                        
                    </select>
                </div>
                @endif
                <div class="col-md-4 mb-3">
                    <select class="form-select users_select" id="lr_action_by_filter" aria-label="Default select example" data-placeholder="<?= get_label('select_actions_by', 'Select Actions By') ?>" multiple>                        
                    </select>
                </div>
                <div class="col-md-4 mb-3">
                    <select class="form-select js-example-basic-multiple" id="lr_status_filter" aria-label="Default select example" data-placeholder="<?= get_label('select_statuses', 'Select statuses') ?>" data-allow-clear="true" multiple>
                ...
                <div class="col-md-4 mb-3">
                    <select class="form-select js-example-basic-multiple" id="lr_type_filter" aria-label="Default select example" data-placeholder="<?= get_label('select_types', 'Select Types') ?>" data-allow-clear="true" multiple>                        
            ...
            <div class="table-responsive text-nowrap">
                ...
                <table id="lr_table" data-toggle="table" data-loading-template="loadingTemplate" data-url="{{ url('/leave-requests/list') }}" data-icons-prefix="bx" data-icons="icons" data-show-refresh="true" data-total-field="total" data-trim-on-search="false" data-data-field="rows" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-side-pagination="server" data-show-columns="true" data-pagination="true" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-query-params="queryParamsLr">
                    <thead>
                        <tr>
