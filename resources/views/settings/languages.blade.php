    ...
    <div class="d-flex justify-content-between mb-2 mt-4">
        ...
        <form action="{{ url('settings/languages/save_labels') }}" class="form-submit-event" method="POST">
            ...
            <div>
                ...
                <a href="{{ url('settings/languages/manage') }}"><button type="button" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="<?= get_label('manage_languages', 'Manage languages') ?>"><i class="bx bx-list-ul"></i></button></a>
            </div>
    </div>
    <div class="card mb-4">
        <div class="card-body">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="mb-3 mt-2">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('drag_and_drop_update_zip_file_here', 'Drag & Drop Update from vX.X.X to vX.X.X.zip file Here',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('enable_disable_signup_info', 'If disabled, team member and client will not be able to create an account by themselves.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('forgot_password_info','Enter your email and we\'ll send you password reset link',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            {!! create_label('reset_password_info','Enter details and hit submit to reset your password',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('please_enter_confirm_new_password', 'Please enter confirm new password',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('toast_position_info', 'Choose where on the screen toast messages will appear.',Session::get('locale')) !!}
                            {!! create_label('toast_time_out_info', 'Set the duration (in seconds) for how long toast messages will be displayed. The default is 5 seconds.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('test_settings', 'Test Settings',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('test_sms_notification_settings_info', 'This is where you can test your SMS notification settings. Before testing, please update the settings if they haven\'t been updated already.',Session::get('locale')) !!}
                            {!! create_label('recipient_phone_number', 'Recipient Phone Number',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('notification_test_recipient_country_code_info', 'Enter if required for the platform you are using.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('test_whatsapp_notification_settings', 'Test WhatsApp Notification Settings',Session::get('locale')) !!}
                            {!! create_label('test_whatsapp_notification_settings_info', 'This is where you can test your WhatsApp notification settings. Before testing, please update the settings if they haven\'t been updated already.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('recipient_whatsapp_number', 'Recipient WhatsApp Number',Session::get('locale')) !!}
                            {!! create_label('allowed_max_upload_size_in_mb_default_512', 'Allowed Max Upload Size (MB) - Default: 512',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('allowed_max_upload_size_info', 'Also, set the `upload_max_filesize` and `post_max_size` PHP configurations on your server accordingly to ensure the maximum upload size works as expected.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('max_attempts_info', 'Fill in if you want to set a limit; otherwise, leave it blank',Session::get('locale')) !!}
                            {!! create_label('max_attempts_info_1', 'The maximum number of login attempts allowed before the account is locked. The default is 5 attempts.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            {!! create_label('lock_time_info_1', 'The duration in minutes for which the account will be locked after exceeding the maximum login attempts.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('currency_restriction', 'Only digits, commas as thousand separators, and a single decimal point are allowed.',Session::get('locale')) !!}
                            {!! create_label('currency_restriction_1', 'Only one decimal point is allowed.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('currency_restriction_2', 'Only digits and a single decimal point are allowed.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                        {!! create_label('type_to_search_users_leave_visible_to', 'Type To Search Users Leave Visible To',Session::get('locale')) !!}
                        ...
                        {!! create_label('primary_workspace_info', 'This workspace will be assigned upon new signup.',Session::get('locale')) !!}                        
                        </div>
                        <div class="row">
                        {!! create_label('default_workspace_info', 'On login, you will be automatically switched to this workspace by default.',Session::get('locale')) !!} 
