            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item active">
                        <?= get_label('sms_gateway_wa', 'SMS gateway/WhatsApp') ?>
                    </li>
                </ol>
            </nav>
        </div>
            ...
            <div class="tab-content px-0">
                <div class="tab-pane fade show active" id="sms-gateway-settings">
                    ...
                    <form action="{{url('settings/store_sms_gateway')}}" class="form-submit-event" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-2">
                            ...
                            <button type="button" class="btn btn-success me-2" id="testSmsSettingsButton"><?= get_label('test_settings', 'Test Settings') ?></button>
                            @endif
                ...
                <div class="tab-pane fade show" id="whatsapp-settings">
                    ...
                    <form action="{{url('settings/store_whatsapp')}}" class="form-submit-event" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <label for="base_url" class="form-label">{{get_label('account_sid','Account SID')}} <span class="asterisk">*</span></label>
                                <input type="text" class="form-control" name="account_sid" value="{{$whatsapp_settings['account_sid'] ?? ''}}" placeholder="{{get_label('twilio_account_sid','Twilio Account SID')}}">
                            </div>
                            <div class="col-md-4">
                                <label for="base_url" class="form-label">{{get_label('auth_token','Auth token')}} <span class="asterisk">*</span></label>
                                <input type="text" class="form-control" name="auth_token" value="{{$whatsapp_settings['auth_token'] ?? ''}}" placeholder="{{get_label('twilio_auth_token','Twilio Auth Token')}}">
                            </div>
                            <div class="col-md-4">
                                <label for="base_url" class="form-label">{{get_label('from_no','From Number')}} <span class="asterisk">*</span></label>
                                <input type="text" class="form-control" name="from" value="{{$whatsapp_settings['from'] ?? ''}}" placeholder="Ex.+009876543210">
                            </div>
                        </div>
                        <div class="mt-2">
                            <button type="submit" class="btn btn-primary me-2" id="submit_btn"><?= get_label('update', 'Update') ?></button>
                            @if (config('constants.ALLOW_MODIFICATION') === 1)
                            <button type="button" class="btn btn-success me-2" id="testWhatsappSettingsButton"><?= get_label('test_settings', 'Test Settings') ?></button>
                            @endif
                            <button type="reset" class="btn btn-outline-secondary"><?= get_label('cancel', 'Cancel') ?></button>
                        </div>
                    </form>
